...
pretrain_data = './resources/datasets/mobvoi_seq_monkey_general_open_corpus.jsonl'
output_pretrain_data = './resources/datasets/seq_monkey_datawhale_32k.jsonl'

# sft_data 为运行download_dataset.sh时，下载的sft_data本地路径
# sft_data = './resources/datasets/BelleGroup/train_3.5M_CN.json'
# output_sft_data = 'BelleGroup_sft.jsonl'

# 1 处理预训练数据
def split_text(text, chunk_size=32768):
    """将文本按指定长度切分成块"""
